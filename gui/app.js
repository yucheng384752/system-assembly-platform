...
async function initMachineGate() {
  ...
  document.getElementById("gate-download-script")?.addEventListener("click", async () => {
    if (typeof JSZip !== "undefined") {
      // Bundle: setup script + pubkey script + README
      const zip = new JSZip();
      ...
      a.href = url; a.download = "tpm-setup-bundle.zip";
      document.body.appendChild(a); a.click(); a.remove();
      URL.revokeObjectURL(url);
    } else {
      // Fallback: single script (JSZip not loaded)
